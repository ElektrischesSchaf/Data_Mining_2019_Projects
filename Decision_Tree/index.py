...
if __name__=="__main__":
    ...
    #gini talbe
    result_table = np.array(table1)
    output1 = pd.DataFrame(data=result_table,index=[3,4,5,6,'no limit'],columns=DATA_NUM)
    print(output1.head())

    #entropy table
    result_table = np.array(table2)
    output2 = pd.DataFrame(data=result_table,index=[3,4,5,6,'no limit'],columns=DATA_NUM)
    print(output2.head())
